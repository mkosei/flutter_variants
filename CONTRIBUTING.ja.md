...
初めての方は [`AGENTS.md`](AGENTS.md) を最初に読んでください。設計思想と守るべき境界を説明しています。利用者向けのAPIリファレンスは [`DOCUMENT.md`](DOCUMENT.md)、現在のロードマップは [`doc/TODO.md`](doc/TODO.md) にあります。
...
- **API実装** — `doc/TODO.md` から選ぶ。特に「v1.0.0までに作りたいAPI」セクションが入りやすい
...
`doc/TODO.md` から選ぶのが基本。小さめのstarter task：
...
`flutter_variants` は [MIT License](LICENSE) で公開しています。PRを送る時点で、あなたの貢献も同じMIT Licenseで提供されることに同意したものとみなします。
